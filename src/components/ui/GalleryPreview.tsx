                        ...
                        >
                            ...
                            {index === 1 && remainingCount > 0 && (
                                <Link
                                    ...
                                    className="absolute inset-0 bg-black/60 backdrop-blur-sm flex flex-col items-center justify-center text-white text-center transition-all hover:bg-black/70 p-2"
                                >
                                    <span className="text-2xl md:text-4xl font-bold">+{remainingCount}</span>
                                    <span className="text-xs md:text-base mt-1 flex items-center justify-center gap-1">
                                        View Full Gallery <ArrowRight className="w-3 h-3 md:w-4 md:h-4" />
                                    </span>
                                </Link>
                            )}
                        </div>
