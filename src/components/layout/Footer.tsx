...
const FooterLink: React.FC<{ href: string; children: React.ReactNode }> = ({ href, children }) => (
    <li>
        <a
            href={href}
            className="text-gray-400 hover:text-yellow-400 transition-colors duration-300 text-sm sm:text-base py-0 sm:py-1 block"
        >
            {children}
        </a>
    </li>
    ...
    return (
        <footer className="bg-slate-900 text-white">
            <div className="container mx-auto px-4 py-6 sm:py-16">
                {/* Main Footer Content */}
                <div className="grid grid-cols-2 lg:grid-cols-4 gap-x-4 gap-y-6 sm:gap-8 mb-8 sm:mb-12">
                    {/* Platform */}
                    <div className="order-1">
                        <h3 className="text-sm font-semibold text-gray-200 tracking-wider uppercase mb-2 sm:mb-4">
                            Platform
                        </h3>
                    ...
                    <div className="order-4">
                        ...
                        <ul className="space-y-0 sm:space-y-2 mb-4 sm:mb-6">
